...
public class CompactTileData
{
    ...
    public static CompactTileData GenerateCompactTileData(CompactTileData compactTileData,
    ...
    public TileData ToTileData() {
        TileTypeData tileTypeData = new() {
            Type = TType
        };

        WallTypeData wallTypeData = new() {
            Type = WType
        };
        ...
        TileWallWireStateData tileWallWireStateData = new() {
            TileFrameX = TFrameX,
            TileFrameY = TFrameY,
